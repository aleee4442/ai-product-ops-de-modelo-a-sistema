...
st.set_page_config(page_title="AI Product Ops · De Modelo a Sistema", page_icon="🤖", layout="wide")
init_state()
...
pages = {
    "Producto": [
        ...
        st.Page("pages/3_disenador_producto.py", title="Diseñador · Wizard", icon="⚙️"),
